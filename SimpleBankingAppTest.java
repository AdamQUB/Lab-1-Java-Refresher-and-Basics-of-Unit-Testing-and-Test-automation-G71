...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		//setup phase:
		//used random numbers
		double balanceBefore = mainApp.getBalance("5495-1234"); //should be 0.00
		//System.out.println(balanceBefore);
		double withdrawalAmount = 20.00;
		
		//Exercise phase
		mainApp.addTransaction("5495-1234", -withdrawalAmount); // this method should deduct 20.00
		double balanceAfter = mainApp.getBalance("5495-1234"); //balance after should be -20.00
